...
// Period control for the payslips list: a Month / Year / Financial-Year toggle
// plus a selector whose options match the mode. Both write the URL
// (?mode=&period=); switching mode drops the stale period so the server resolves
// the newest one. Mirrors the dashboard's period control.
...
export function PayslipControls({
  mode,
  selected,
  months,
  years,
